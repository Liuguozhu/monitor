package com.coder.monitor.util.captcha;

import java.awt.*;
import java.io.OutputStream;

import static com.coder.monitor.util.captcha.Randoms.alpha;
import static com.coder.monitor.util.captcha.Randoms.num;
